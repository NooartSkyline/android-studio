...
public class MainDemo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            nextModelList.add(item);
            item = new NextModel();
            item.setNextTitle("TreeActivity");
            item.setActivity((Class<? extends AppCompatActivity>) Class.forName("jsynctech.com.app_demo.DEMO1.ViewNextActivity.Main2Activity"));
            nextModelList.add(item);
        ...
        demo1Adapter.setOnItemClickListenerNextActivity(new InterfaceNext() {
            ...
            public void setOnClickListener(int position) {
                ...
                Intent intent = new Intent(getApplicationContext(),item .getActivity());
